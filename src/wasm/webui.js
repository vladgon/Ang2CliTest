...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "webui.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "webui.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'webui'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'webui':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            env: {
                "__cargo_web_snippet_0cafa60f0d56a4a0e967649b62c08c9d468b5a13": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);console.log("Hello, World, console macro! - "+($0));
            },
            ...
            "__cargo_web_snippet_bb47ac649d4db8dbad4c9ca895708d5b1ff212ae": function() {
                Rust.webui.then(function(webui){window.WebUI=webui});
            },
            "__cargo_web_snippet_bbf3cb89eaa24c1ec05db3190b9195ba44a4ec47": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);console.log("Hello "+"!");var print_hello=($0);print_hello("Bob");print_hello.drop();
            },
        ...
        initialize: function( instance ) {
            ...
            Module.exports.print_from_js = function print_from_js(param) {
    Module.instance.exports.print_from_js(Module.STDWEB_PRIVATE.prepare_any_arg(param));
}
;
            __web_on_grow();
